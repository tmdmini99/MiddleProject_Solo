...
<div class="container-fluid">
	<div class="row col-md-6 mx-auto my-5">
		...
		<div class="form-check">
		  <input class="form-check-input checkd" type="checkbox" value=""  id="check1" >
			<label for="check1" class="mydiv">
				제 1 장 총 칙
...
[부칙]
		...
		<div class="form-check">
		  <input class="form-check-input checkd" type="checkbox" value=""  id="check2" >
		  <label class="form-check-label" for="check2">
		    동의2
		  </label>
		</div>
		<div class="form-check">
		  <input class="form-check-input checkd" type="checkbox" value=""  id="check3" >
		  <label class="form-check-label" for="check3">
		    동의3
		  </label>
		</div>
		<div>
			<button id="agree" class="btn btn-info">회원가입</button>
		</div>
	</div>
</div>
