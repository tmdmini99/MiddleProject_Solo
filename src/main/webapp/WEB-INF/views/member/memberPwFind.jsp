...
<body>
	...
	<div class="form-floating" id="findPw">
      <input type="text" class="form-control" id="id" name="id" placeholder="Id입력">
      <label for="floatingInput">Id입력</label>
      <div class="form-group">
        <label for="memberEmail" class="form-label mt-4">본인 확인 이메일</label>
     <input type="text" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="선택입력">
      ...
      <button type="submit" id="btn1">찾기</button>
    </div>
    </form>
